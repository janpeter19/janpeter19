...
- **Note** The Google Colab VM has in mid January been updated to Ubuntu 20.04 and runs now Python 3.8 and enables us to use the latest version of the key package PyFMI.  This is all good news! However, the old notebooks and files must be updated to work. I will update the scripts, the compiled FMUs, and the notebooks slightly.  I have started with BPL_TEST2_Batch and will go through the repositories one by one.  For repositories not yet updated you can always look at the PDF-version of the notebooks. To see  which repositories that are updated you take a look at the brief description of the repositories and ends with "Updated".
