...
- **Note** Just before Christmas there was some change in the "Conda/Python universe" that make my colab-scripts not work anymore. I will try to fix it during January. In the meantime you can look at the PDF-version of the notebooks. If you badly want to run notebooks, send me a mail and I can help you with a local Linux installation.
